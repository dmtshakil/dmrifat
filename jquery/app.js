...
$(document).ready(function () {
    ...
    function adjustImageSize() {
        ...
        if (windowWidth < 768) {
            $('.image-content2 img').css('width', '330px');
            $('.image-content1 img').css('width', '350px');
        } else {
            $('.image-content2 img').css('width', '400px');
            $('.image-content1 img').css('width', '415px');
        }
    }
...
var swiper = new Swiper(".slide-content", {
    ...
    grabCursor: true,
    autoplay: {
        delay: 3000, // প্রতি ৩ সেকেন্ড পর পর slide হবে
        disableOnInteraction: false, // user হাত দিয়ে swipe করলেও autoplay বন্ধ হবে না
    },
    pagination: {
